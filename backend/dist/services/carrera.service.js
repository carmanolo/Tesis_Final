...
export async function createCarreraSer(nombre_carrera, sigla) {
...
export async function getCarrerasSer() {
    try {
        const carreraRepository = AppDataSource.getRepository(CarreraEntity);
...
export async function getCarreraSer(id_carrera) {
    try {
        const carreraRepository = AppDataSource.getRepository(CarreraEntity);
...
export async function patchCarreraSer(carrera) {
    const userRepository = AppDataSource.getRepository(CarreraEntity);
    try {
        if (!carrera) {
            throw new Error("Funcion mal llamada");
        }
        const savedCarrera = await userRepository.save(carrera);
...
export async function deleteCarreraSer(id_carrera) {
    try {
        const carreraRepository = AppDataSource.getRepository(CarreraEntity);
...
export async function obtenerListaCarreras() {
    try {
        const carreraRepository = AppDataSource.getRepository(CarreraEntity);
...
export async function obtenerCarreraPorSigla(sigla) {
    try {
        if (SHOW_ERRORS) {
