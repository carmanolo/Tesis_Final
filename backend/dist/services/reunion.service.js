...
export async function getReunionesSer() {
    try {
        const reunionRepository = AppDataSource.getRepository(ReunionEntity);
...
export async function getReunionSer(id_reunion) {
    try {
        const reunionRepository = AppDataSource.getRepository(ReunionEntity);
...
export async function patchReunionSer(reunion) {
    const reunionRepository = AppDataSource.getRepository(ReunionEntity);
    try {
        if (!reunion) {
            throw new Error("Funcion mal llamada");
...
export async function deleteReunionSer(id_reunion) {
    try {
        const reunionRepository = AppDataSource.getRepository(ReunionEntity);
...
export async function subirActaSer(id_reunion, file) {
    const reunionRepository = AppDataSource.getRepository(ReunionEntity);
    try {
        const reunion = await reunionRepository.findOne({ where: { id_reunion } });
        if (!reunion) {
...
export async function obtenerActaSer(id_reunion) {
    try {
        const reunionRepository = AppDataSource.getRepository(ReunionEntity);
        const reunion = await reunionRepository.findOne({ where: { id_reunion } });
