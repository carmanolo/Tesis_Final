...
export async function getCarreras(req: Request, res: Response): Promise<any> {
  try {
...
export async function getCarreraById(req: Request, res: Response): Promise<any> {
  try {
...
export async function patchCarreraById(req: Request, res: Response): Promise<any> {
  try {
...
export async function deleteCarreraById(req: Request, res: Response): Promise<any> {
  try {
    const { id_carrera } = req.params;
    if (!id_carrera) {
