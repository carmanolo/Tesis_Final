...
import { MIN_FULLCARRERA, MAX_FULLCARRERA, CARRERA_PERMITIDA, CARRERA_REGEX,  CARRERA_NO_ENCONTRADA, CARRERA_OBLIGATORIO, SIGLA_OBLIGATORIA, CAMPOS_ADICIONALES, MAX_SIGLA, MIN_SIGLA} from "../constants/carrera.constants.js";
